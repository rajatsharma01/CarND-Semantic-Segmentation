...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    for e in range(epochs):
        ...
        for image, label in get_batches_fn(batch_size):
            ...
            print("Batch: {}. Loss: {}".format(num_batch+1, loss))
        ...
        print("-----------------------------------------")
        print("Epoch completed in {} s.".format(time.time() - start_ts))
...
def run():
    ...
    with tf.Session() as sess:
        ...
        logits, train_op, loss_op = optimize(output, correct_label, learning_rate, num_classes)
